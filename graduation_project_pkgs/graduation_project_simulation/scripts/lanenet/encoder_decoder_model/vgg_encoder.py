...
class VGG16Encoder(cnn_basenet.CNNBaseModel):
    ...
    def encode(self, input_tensor, name):
        ...
        with tf.compat.v1.variable_scope(name):
            ...
            w1 = tf.compat.v1.get_variable('W1', [1, 9, 128, 128],
            ...
            w2 = tf.compat.v1.get_variable('W2', [1, 9, 128, 128],
                                 initializer=tf.random_normal_initializer(0, math.sqrt(2.0 / (9 * 128 * 128 * 5))))
            ...
            w3 = tf.compat.v1.get_variable('W3', [9, 1, 128, 128],
                                 initializer=tf.random_normal_initializer(0, math.sqrt(2.0 / (9 * 128 * 128 * 5))))
            ...
            w4 = tf.compat.v1.get_variable('W4', [9, 1, 128, 128],
                                 initializer=tf.random_normal_initializer(0, math.sqrt(2.0 / (9 * 128 * 128 * 5))))
            ...
            ret['prob_output'] = tf.image.resize(conv_output, [CFG.TRAIN.IMG_HEIGHT, CFG.TRAIN.IMG_WIDTH])
